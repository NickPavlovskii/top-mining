import heroContainer from '~/assets/images/stroitelstvo-data-czentrov/hero-container.png'
import investIconNoRisk from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-1.svg'
import investIconStableIncome from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-2.svg'
import investIconEarnings from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-3.svg'
import investIconNoEntryFee from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-4.svg'
import investIconEnergySave from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-5.svg'
import investIconNoDeposit from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-6.svg'
import investIconScale from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-7.svg'
import investIconControl from '~/assets/images/stroitelstvo-data-czentrov/invest/invest-wrap-icon-8.svg'

export const STROITELSTVO_DATA_CZENTROV_PAGE_PATH = '/stroitelstvo-data-czentrov/'

export const STROY_CALC_FOOTNOTE =
...
export const STROY_CALCULATOR_HREF = '/calculator/'

export const STROY_CTA_FORM_DEFAULTS = {
...
export type StroyCtaFormDefaults = typeof STROY_CTA_FORM_DEFAULTS

export type StroyCtaFormVariant = 'hero' | 'compact'

export type StroyCtaFormSubmitPayload = {
  phone: string
}

export type StroyCtaFormCardProps = {
  title: string
  text: string
  submitLabel: string
  ...
  privacyHref?: string
  titleId?: string
  variant?: StroyCtaFormVariant
}

export type StroyCtaSectionCopy = {
  id: string
  title: string
  text: string
  submitLabel: string
} & StroyCtaFormDefaults

export type StroyMiniTableRow = {
  label: string
  value: string
  accent?: boolean
}

export type StroyMiniTable = {
  title: string
  rows: readonly StroyMiniTableRow[]
}

export type StroyBusinessModelBase = {
  id: string
  label: string
  title: string
  invested: string
...
export type StroyBusinessModelGrid = StroyBusinessModelBase & {
  kind: 'grid'
  highlightColumn: number
  columns: readonly (readonly string[])[]
}

export type StroyBusinessModelText = StroyBusinessModelBase & {
  kind: 'text'
  paragraphs: readonly { html: string }[]
}

export type StroyBusinessModelDual = StroyBusinessModelBase & {
  kind: 'dual'
  miniTables: readonly StroyMiniTable[]
}

export type StroyBusinessModelItem =
  | StroyBusinessModelGrid
  | StroyBusinessModelText
  | StroyBusinessModelDual

export type StroyStageItem = {
  title: string
  intro?: string
  introLast?: boolean
...
export type StroyPowerIconId = 'gaz' | 'el'

export type StroyPowerAlign = 'gaz-4' | 'gaz-6' | 'row-2' | 'row-3' | 'row-7'

export type StroyPowerCompareItem = {
  label: string
  text: string
  align?: StroyPowerAlign
}

export type StroyPowerCompareColumn = {
  id: string
  title: string
  icon: StroyPowerIconId
  items: readonly StroyPowerCompareItem[]
}

export type StroyWhyCompareCell = {
  title: string
  paragraphs: readonly string[]
}

export type { TopMiningCompareTableRow as StroyCompareTableRow } from './compare-table'
export { toCompareTableRows } from './compare-table'

export const STROITELSTVO_DATA_CZENTROV_PAGE = {
  ...
  models: {
    ...
    calculatorHref: STROY_CALCULATOR_HREF,
    ...
    calcFootnote: STROY_CALC_FOOTNOTE,
    scenarioLabels: [
      'Оптимальная модель',
    ...
    ] satisfies readonly StroyBusinessModelItem[],
  },
  whyInvest: {
  ...
  stages: {
    ...
    ] satisfies readonly StroyStageItem[],
  },
  lead: {
    id: 'stroy-lead',
  ...
  powerCompare: {
    ...
    ] satisfies readonly StroyPowerCompareColumn[],
  },
} as const

export type StroitelstvoDataCzentrovPage = typeof STROITELSTVO_DATA_CZENTROV_PAGE
