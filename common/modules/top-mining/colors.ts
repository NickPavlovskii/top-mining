...
export const TM_ORANGE_GRADIENT_START = '#ff7b20' as const
export const TM_ORANGE_ACCENT_LIGHT = '#ff741f' as const
export const TM_ORANGE_ACCENT_DEEP = '#ec5100' as const
