...
<script setup lang="ts">
  import { emptyCatalogResponse } from '~/common/modules/catalog'
  import {
  ...
  import CatalogCategorySidebarFilters from '~/components/catalog/filters/CatalogCategorySidebarFilters.vue'
  import CatalogManufacturersFilters from '~/components/catalog/filters/CatalogManufacturersFilters.vue'
  import CatalogOrganizationsFilters from '~/components/catalog/filters/CatalogOrganizationsFilters.vue'
  import CatalogMidBlockBanner from '~/components/catalog/shared/CatalogMidBlockBanner.vue'
...
<style scoped>
  ...
  .catalog-mfr-page__layout > :first-child {
    min-width: 0;
    max-width: 100%;
  }
  ...
  .catalog-mfr-page__grid-banner {
    ...
    container-name: catalog-mid-block;
  }
