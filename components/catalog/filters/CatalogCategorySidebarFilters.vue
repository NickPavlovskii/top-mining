  ...
  <aside class="catalog-cat-filters">
    <div class="catalog-cat-filters__panel">
      ...
      >
        ...
        >
          <span class="catalog-cat-filters__section-title">{{ group.title }}</span>
          <template #append>
            <Icon
              name="mdi:chevron-up"
              :class="[
...
<style scoped>
  ...
  .catalog-cat-filters__section-head:deep(.top-mining-button) {
    width: 100%;
    min-height: 0;
    padding: 16px 18px;
    border-radius: 0;
  ...
  .catalog-cat-filters__section-head:deep(.top-mining-button__inner) {
    width: 100%;
    justify-content: space-between;
    gap: 12px;
  }

  .catalog-cat-filters__section-title {
    min-width: 0;
    text-align: left;
  }
  ...
  .catalog-cat-filters__select-all:deep(.top-mining-button) {
    min-height: 0;
    padding: 0;
    font-size: 13px;
    font-weight: 600;
