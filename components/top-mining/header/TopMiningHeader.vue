...
<script setup lang="ts">
  ...
  const { isMobileViewport, isPhoneViewport } = useViewportBreakpoint({
    mobile: MOBILE_HEADER_BREAKPOINT,
...
<style>
  ...
  .top-mining__header-actions .top-mining-button--consulting {
    flex-shrink: 0;
  ...
  .top-mining__header-actions .top-mining-button--consulting .top-mining-button__inner {
    flex: 0 0 auto;
    justify-content: center;
  }

  .top-mining__header-actions .top-mining-button--consulting .top-mining-button__inner span,
  .top-mining__header-actions .top-mining-button--consulting .top-mining-button__inner div {
    justify-content: center;
    text-align: center;
  }

  .top-mining__header-actions .top-mining-button__inner {
    justify-content: center;
  }

  .top-mining__header-actions .top-mining-button__consulting-label {
    display: inline-block;
    line-height: 1;
    text-align: center;
  ...
  .top-mining__header-actions .top-mining-button--consulting:hover,
  .top-mining__header-actions .top-mining-button--consulting:focus-visible {
  ...
  @media (hover: hover) {
    .top-mining__consulting-wrap:hover .top-mining-button--consulting,
    .top-mining__consulting-wrap:focus-within .top-mining-button--consulting {
    ...
    .top-mining__consulting-wrap:hover .top-mining-button--consulting .top-mining-button__inner,
    .top-mining__consulting-wrap:hover .top-mining-button--consulting .top-mining-button__label,
    .top-mining__consulting-wrap:focus-within .top-mining-button--consulting .top-mining-button__inner,
    .top-mining__consulting-wrap:focus-within .top-mining-button--consulting .top-mining-button__label {
      color: var(--tm-orange) !important;
    }
  }
  ...
  .top-mining__nav-contact-btn svg {
    width: 17px;
    height: 17px;
  }
