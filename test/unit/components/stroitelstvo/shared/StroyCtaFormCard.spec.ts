...
import type { StroyCtaFormCardProps } from '~/common/modules/top-mining/stroitelstvo-data-czentrov-page'
import StroyCtaFormCard from '~/components/stroitelstvo/shared/StroyCtaFormCard.vue'
...
describe('StroyCtaFormCard', () => {
  function mountCard(props: Partial<StroyCtaFormCardProps> = {}) {
    return mount(StroyCtaFormCard, {
      props: {
        title: 'Заголовок\nвторая строка',
        text: 'Подпись формы',
  ...
  it('applies compact variant class', () => {
    ...
    expect(wrapper.classes()).toContain('stroy-cta-form-card--compact')
  })
